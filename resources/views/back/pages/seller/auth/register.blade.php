...
<div class="auth-container-fluid">
    <div class="auth-side-left">
        <div class="auth-content-wrapper-left">
            ...
            <span class="seller-badge">Untuk Penjual</span>

            <a href="{{ route('seller.login') }}" class="btn-outline-register">Masuk</a>
    ...
    <div class="auth-side-right">
        <div class="auth-content-wrapper">
            <h2 class="form-title-rounded">Buka Toko</h2>
            ...
            <form method="POST" action="{{ route('seller.register-handler') }}" style="width: 100%; display: flex; flex-direction: column; align-items: center;">
                @csrf
                <div class="pill-group">
                    <i class="fa fa-id-card"></i>
                    <input type="text" name="name" class="pill-field" placeholder="Nama Lengkap" value="{{ old('name') }}" required>
                </div>
                <div class="pill-group">
                    <i class="fa fa-store"></i>
                    <input type="text" name="shop_name" class="pill-field" placeholder="Nama Toko" value="{{ old('shop_name') }}" required>
                </div>
                <div class="pill-group">
                    <i class="fa fa-envelope"></i>
                    <input type="email" name="email" class="pill-field" placeholder="Alamat Email" value="{{ old('email') }}" required>
                </div>
                <div class="pill-group">
                ...
                <div class="pill-group">
                    ...
                    <input type="password" name="password_confirmation" class="pill-field" placeholder="Konfirmasi Password" required>
                </div>
                <button type="submit" class="btn-tosca-short">Daftar Toko</button>
            </form>
