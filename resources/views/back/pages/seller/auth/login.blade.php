...
<div class="auth-container-fluid">
    <div class="auth-side-left">
        <div class="auth-content-wrapper-left">
            ...
            <h3 class="left-title">Belum Punya Toko?</h3>
            <p class="left-desc">Buka toko ikan kamu sekarang juga <strong>Gratis!!</strong></p>

            <a href="{{ route('seller.register') }}" class="btn-outline-register">Daftar Toko</a>
    ...
    <div class="auth-side-right">
        <div class="auth-content-wrapper">
            <h2 class="form-title-rounded">Masuk Penjual</h2>
            ...
            <form method="POST" action="{{ route('seller.login-handler') }}" style="width: 100%; display: flex; flex-direction: column; align-items: center;">
                @csrf
                <div class="pill-group">
                    <i class="fa fa-user"></i>
                    <input type="email" name="email" class="pill-field" placeholder="Email Toko" value="{{ old('email') }}" required>
                </div>
                <div class="pill-group">
