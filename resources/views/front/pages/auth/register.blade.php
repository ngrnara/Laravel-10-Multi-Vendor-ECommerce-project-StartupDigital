...
<div class="auth-container-fluid">
    <div class="auth-side-left">
        <div class="auth-content-wrapper-left">
            ...
            <h3 class="left-title">Sudah Punya Akun?</h3>
            <p class="left-desc">Yuk langsung masuk kembali untuk memantau bursa komoditas iwak Anda.</p>

            <a href="{{ route('client.login') }}" class="btn-outline-register">Masuk</a>
    ...
    <div class="auth-side-right">
        <div class="auth-content-wrapper">
            <h2 class="form-title-rounded">Buat Akun</h2>
            ...
            <form method="POST" action="{{ route('client.register-handler') }}" style="width: 100%; display: flex; flex-direction: column; align-items: center;">
                @csrf
                ...
                <button type="submit" class="btn-tosca-short">Daftar</button>
            </form>
