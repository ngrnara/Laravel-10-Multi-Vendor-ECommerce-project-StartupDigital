  ...
  <div class="wrap">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <p class="brand-tagline">Sistem Informasi Pasar Iwak</p>
        <p class="brand-desc">
          Menghubungkan petani ikan air tawar langsung dengan pembeli — tanpa tengkulak, harga jual lebih adil, panen lebih mudah dipantau.
        </p>
        <div class="map-frame">
          <iframe
            src="https://www.google.com/maps?q=Universitas+Dian+Nuswantoro,+Jl.+Nakula+I+No.5-11,+Semarang&output=embed"
            width="100%" height="130" style="border:0; display:block;"
            loading="lazy" referrerpolicy="no-referrer-when-downgrade"
            title="Lokasi Lapak Ikan"></iframe>
        </div>
      </div>

      <!-- Kolom 2: Menu Cepat -->
      <div class="footer-col">
        <h4 class="col-title">MENU CEPAT</h4>
        <ul class="col-list vertical-menu">
          <li><a href="#">Home</a></li>
          <li><a href="#">Lapak Ikan</a></li>
      ...
      <div class="footer-col">
        <h4 class="col-title">LAYANAN PELANGGAN</h4>
        <ul class="col-list vertical-menu">
          <li><a href="#">Bantuan</a></li>
          <li><a href="#">Metode Pembayaran</a></li>
          <li><a href="#">Garansi Lapak</a></li>
      ...
      <div class="footer-col">
        ...
        <div class="social-row">
          <a href="#" aria-label="Twitter Lapak Ikan"><span class="tip">Twitter</span>
          ...
          <a href="#" aria-label="Facebook Lapak Ikan"><span class="tip">Facebook</span>
          ...
          <a href="#" aria-label="LinkedIn Lapak Ikan"><span class="tip">LinkedIn</span>
          ...
          <a href="#" aria-label="Instagram Lapak Ikan"><span class="tip">Instagram</span>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/></svg>
          </a>
        </div>
      </div>
    ...
    <div class="sub-footer">
      <span>&copy; <span id="sipari-footer-year">2026</span> LAPAK IKAN — Sistem Informasi Pasar Iwak. Hak cipta dilindungi.</span>
      <div class="sub-links">
    ...
    <!-- Informasi Detail Rahasia saat Badge Di-hover/Fokus -->
    <div class="logo-dock">
      <div class="logo-hover" tabindex="0">
        <div class="logo-badge">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 6c-4 0-7.5 2.4-9.5 4.5C3.6 9.6 2.3 8.7 1 8c.3 1.3 1 3 2 4-1 1-1.7 2.7-2 4 1.3-.7 2.6-1.6 3.5-2.5C6.5 15.6 10 18 14 18c5 0 9-3.5 9-6s-4-6-9-6zm3.5 6a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5z"/></svg>
        </div>
        <div class="logo-detail">
          <p class="ld-title">LAPAK<span>IKAN</span></p>
          <p>Sistem Informasi Pasar Iwak (SIPARI) — Menghubungkan pembudidaya ikan langsung dengan pembeli dari kolam ke keranjang.</p>
          <p class="ld-meta">Fakultas Ilmu Komputer — UDINUS, Semarang<br>Proposal Kuliah Kerja Industri</p>
        </div>
      </div>
    </div>
...
<style>
  ...
  .sipari-footer *, .sipari-footer *::before, .sipari-footer *::after {
    box-sizing: border-box;
  }
  ...
  .sipari-footer .sub-footer a:hover { color: var(--text-light) !important; }
  .sipari-footer .sub-links { display: flex !important; gap: 20px !important; flex-wrap: wrap !important; }
...
<script>
  document.getElementById('sipari-footer-year').textContent = new Date().getFullYear();
</script>